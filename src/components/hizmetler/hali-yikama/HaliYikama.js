...
function HaliYikama() {
    useDocumentTitle('Kalıcı Makyaj- Bercislina Epilasyon ve Güzellik Merkezi');
    return (
        <div className="col-12">
        <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
            <img src={kalicimakyaj} class="hizmet-photo" title="Halı Yıkama" alt="Halı Yıkama" ></img>
            <div className="card-body col-12">
                <br/>
                <p class="hizmet-title" >Kalıcı Makyaj</p>
