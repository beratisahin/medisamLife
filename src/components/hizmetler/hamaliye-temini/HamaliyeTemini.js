...
function HamaliyeTemini() {
    useDocumentTitle('Epilasyon - Bercislina Epilasyon ve Güzellik Merkezi');
    return (
        <div className="col-12">
        <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
            <img src={epilasyon} class="hizmet-photo" title="Hamaliye Temini" alt="Hamaliye Temini" ></img>
            <div className="card-body col-12">
                <br/>
                <p class="hizmet-title" >Epilasyon</p>
