...
function EvTemizligi() {
    useDocumentTitle('Cilt Bakım - Bercislina Epilasyon ve Güzellik Merkezi');
    return (
    <div className="col-12">
        <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
            <img src={ciltBakim} class="hizmet-photo" title="Ev temizliği" alt="Ev Temizliği" ></img>
            <div className="card-body col-12">
                <br/>
                <p class="hizmet-title" >Cilt Bakım</p>
