...
export default class Services extends Component {
    ...
    render() {
           ...
           return (
                   ...
                   <div>
                        <div className="col-12 m-4 pl-5 pr-5 pt-2 pb-2 card-temp" style={{backgroundColor:"#FFEFFB",borderRadius:"1rem",textAlign:"center",height:"40rem",border:"3px #C92798 solid"}}>
