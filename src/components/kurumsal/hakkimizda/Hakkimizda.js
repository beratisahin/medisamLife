    ...
    return (
        ...
        <div class="row" style={{border:"2px dotted white",justify: "center",margin:"20px"}}>
            ...
            <div className="hakkımızda" style={{minHeight:"40rem"}}>
                <h3 style={{textAlign:"center",color:"#C92798"}}><b>Hakkımızda</b></h3>
                <p className="kurumsal_text" >Huzurlu atmosferi, güvenliği, teknolojik donanımı, deneyimli güler yüzlü ekibi ile estetik ve güzellik sektöründe Serdivan’da merkezi konumuyla siz değerli müşterilerimizin hizmetinizdedir.
